...
```{r topics_overview_bar}
#| fig-alt: "Horizontal bar chart of petition topics in the Power of Petitioning Quarter Sessions collections, in descending order of frequency; litigation and poor relief are the most popular topics by some distance."
...
```{r topics_counties_bar}
#| fig-alt: "horizontal bar chart of QS petition topics, faceted by county; litigation is top topic in Ches, Staffs and Westmr, poor relief top in Derbyshire, Herts and Worcs."
...
```{r topics_county_topics_pc_bar}
#| fig-alt: "Faceted bar chart of QS petition topics, comparing topic percentage for each county."
...
```{r  topics_counties_mosaic}
#| fig.alt: "mosaic plot of QS petition topics by county; highlighting significat over- or under-representation of topics."
...
```{r topics_decades_stacked_bar}
#| fig-alt: "stacked bar chart of QS petition topics per decade; cluttered and hard to make much sense of what is going on."
qs_petitions_combined |> 
...
```{r topics_decades_faceted_bar}
#| fig-alt: "faceted bar chart of QS petition topics per decade; a bit easier to make comparisons than with a stacked bar chart."
...
```{r topics_decades_pc_heatmap}
#| fig-alt: "heatmap of QS petition topics per decade, using percentages of topic rather than numbers; useful to draw attention to the most exceptional topic-decades."
...
```{r topics_gender_prop_stacked_bar}
#| fig-alt: "proportional stacked bar chart of QS petition topics by gender."
...
```{r topics_gender_mosaic}
#| fig-alt: "mosaic plot of QS petition topics by gender; notable features include: female/paternity and poor relief petitions are over-represented, male paternity under-represented."
...
```{r topics_gender_heatmap}
#| fig-alt: "heatmap of QS petition topics by gender, using percentage of gender rather than numbers. Intriguing hotspot for mixed gender/litigation petitions."
