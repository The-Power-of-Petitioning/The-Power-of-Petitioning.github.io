...
The last of these can be difficult to interpret. In most cases, it's *not* because the petition was written by the petitioner; inspection of the Cheshire images indicates that the only instances of this were less formal petitionary letters. In some cases - certainly for subscribers - it looks possible that the petition is a copy rather than the original document. For petitioners it's hard to be sure whether it's a copy of an original autograph or a scribal decision to write out the name as a kind of pseudo-signature and so I'll only include them in breakdowns by signature type.
...
Moreover, as we'll see, even when combined marks and initials are not very common - considerably less common, I suspect, than in witness examinations even though I might expect petitioners to be of fairly similar social status to witnesses.
